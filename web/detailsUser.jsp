<%-- 
    ...
    Created on : Mar 20, 2020, 9:09:49 PM
    Author     : hungn
--%>
...
<html>
    ...
    <body>
        ...
        <c:set var="result" value="${requestScope.ADMIN2}"/>
    ...
    <c:if test="${numberpage == 1}">
        <nav>
            <ul class="pagination">
                ...
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=1" class="page-link">1</a></li>
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=2" class="page-link">2</a></li>
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=3" class="page-link">3</a></li>
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=${numberpage + 1}" class="page-link">Next</a></li>
            </ul>
        </nav>
    </c:if>
    <c:if test="${numberpage == maxpageid}">
        <nav>
            <ul class="pagination">
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=${numberpage - 1}" >Previous</span></li>
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=1" class="page-link">1</a></li>
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=2" class="page-link">2</a></li>
                <li class="page-item"><a href="AdminController?btAction=ViewUser&pageid=3" class="page-link">3</a></li>
